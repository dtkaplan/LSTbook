...
We hope to have `{LSTbook}` available on CRAN by February 2024. In the meanwhile, you can install the development version of `{LSTbook}` from [GitHub](https://github.com/) with:
