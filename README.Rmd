...
To illustrate how `{LSTbook}` supports teaching such topics in a unified and streamlined way, consider the datasets provided by the `{mosaicData}` package: `Galton`, which contains the original data used by Francis Galton in the 1880s to study the heritability of genetic traits, specifically, human height; and `Whickham` results from a 20-year follow-up survey to study smoking and health.
