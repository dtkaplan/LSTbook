...
#' @keywords datasets
#'
#' @source Ramsey, F.L. and Schafer, D.W. (2013). *The Statistical Sleuth: A
#' Course in Methods of Data Analysis (3rd ed)*, Cengage Learning.
#'
#' @references Holst, P.A., Kromhout, D. and Brand, R. (1988).  "For Debate: Pet Birds
#' as an Independent Risk Factor for Lung Cancer" *British Medical Journal* **297**: 13--21.
"Birdkeepers"
